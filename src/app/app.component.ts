...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    let dataForPivotGrid = this.getSales();
    let fieldsForPivotGrid = this.buildFieldsForPivotGrid();
    this.pivotGridDataSource = new PivotGridDataSourceBuilder()
      .setFields(fieldsForPivotGrid)
      .setData(dataForPivotGrid)
  ...
  private buildFieldsForPivotGrid() {
    let fields = [{
      caption: 'Region',
      width: 120,
      dataField: 'region',
