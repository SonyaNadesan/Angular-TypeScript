...
export class FutureAndPresent extends BaseDateRangeRule implements IDateRangeRule {
    validate(fromDate: Date, toDate: Date): FromAndToDate {
        let fromAndToDate = this.basicValidate(fromDate, toDate, DateRangeRules.FutureAndPresent);
